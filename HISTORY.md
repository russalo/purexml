...
> No drafts in flight. The ElementTree family is complete (v0.3.0) and the first
> mirror-plus slice (v0.4.0 opt-in structural-DoS caps) has shipped. The build axis
> to 1.0 is done; remaining is adoption validation + the freeze ceremony — see
> [`docs/ROADMAP-to-1.0.md`](docs/ROADMAP-to-1.0.md). Next RFC is the v1.0 freeze.
>
